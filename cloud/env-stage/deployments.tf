...
module "opensearch_helm" {
  ...
  set_values = [
    { name = "clusterName", value = "opensearch-stag-cluster" },
    ...
    { name = "persistence.storageClass", value = "ebs-gp3" },
...
module "kiali_helm" {
  ...
  set_values = [
    ...
    { name = "external_services.grafana.url", value = "https://grafana.dev.ezbooking.lk" },
