...
# Stage Application Set
module "argocd_helabooking_stage_app" {
  source = "../cluster-templates/application"

  argocd_application_name      = "helabooking-stage"
  argocd_repo_branch           = "main"
  argocd_application_path      = "overlays/env-stage"
  argocd_application_namespace = "env-stage"
}
