...
7. **Create Git Webhook (Optional)**:
   ...
   - In the Git repository settings --> Webhooks, add a webhook pointing to `https://jenkins.management.ezbooking.lk/generic-webhook-trigger/invoke?token=<unique-name>` as `application/json` type.
